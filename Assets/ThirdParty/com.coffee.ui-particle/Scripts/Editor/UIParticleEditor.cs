...
namespace Coffee.UIExtensions
{
    ...
    internal class UIParticleEditor : GraphicEditor
    {
        ...
        private SerializedProperty _spTurnOnPSOnDisable;
        ...
        protected override void OnEnable()
        {
            ...
            _spTurnOnPSOnDisable = serializedObject.FindProperty("_turnOnPSOnDisable");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Maskable
            EditorGUILayout.PropertyField(_spTurnOnPSOnDisable);
